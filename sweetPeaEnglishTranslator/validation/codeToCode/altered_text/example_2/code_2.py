...
def is_condi_2_2_0(letter):
    return letter[2] != letter[0] and letter[2] == letter[1]
condi = factor("condi", [derived_level("1/1/0", window(is_condi_1_1_0, [letter], 3, 1), 3), derived_level("1/2/0", window(is_condi_1_2_0, [letter], 3, 1), 1), derived_level("2/1/0", window(is_condi_2_1_0, [letter], 3, 1), 17), derived_level("2/2/0", window(is_condi_2_2_0, [letter], 3, 1), 3)])
### EXPERIMENT
